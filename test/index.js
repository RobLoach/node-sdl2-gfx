...
// Load the image.
var image = sdl.SDL_LoadBMP("test/sample8.bmp")
if (!image) {
  console.log("SDL_CreateWindow Error: " + sdl.SDL_GetError())
  process.exit(1)
}
var rotatedImage = gfx.rotozoomSurfaceXY(image, 40, 1.5, 2.5, 0)

// Stick the image on the window.
sdl.SDL_BlitSurface(rotatedImage, null, surface, null)
...
sdl.SDL_FreeSurface(rotatedImage)
